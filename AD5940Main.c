...
void AD5940ImpedanceStructInit(void)
{
  ...
  pImpedanceCfg->FifoThresh = 4;
	...
	//pImpedanceCfg->SweepCfg.SweepStop = 10e3f;		/* Stop at 100kHz */
	//pImpedanceCfg->SweepCfg.SweepPoints = 101;		/* Points is 101 */
	pImpedanceCfg->SweepCfg.SweepStart = 100.0f;	/* Start from 1kHz */
	pImpedanceCfg->SweepCfg.SweepStop = 100;		/* Stop at 10kHz */
	pImpedanceCfg->SweepCfg.SweepPoints = 2;		/* Points is 2 */
